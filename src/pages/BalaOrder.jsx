...
import { balaOrder } from "../utils/api";

const BalaOrder = ({ globalFilter, onAddNew, onExportExcel, onExportPDF }) => {
  ...
  const columns = useMemo(
    () => [
      {
        accessorKey: "jobno_oms",
        header: "jobno_oms",
        enableColumnFilter: true,
        filterFn: "text",
      },
      {
        accessorKey: "insdatenew",
        header: "insdatenew",
      ...
      {
        accessorKey: "order_follow_up",
        header: "order_follow_up",
        enableColumnFilter: true,
        filterFn: "text",
      },
      {
        accessorKey: "quality_controller",
        header: "quality_controller",
        enableColumnFilter: true,
        filterFn: "text",
      },
      {
